...
import (
	...
	"github.com/scmn-dev/core/cookie"
...
func notifyAdminEmail(user *model.User) {
	subject := "$PASSWORD_MANAGER_NAME New User Subscription"
	body := "$PASSWORD_MANAGER_NAME has new a user. User details:\n\n"
	body += "Name: " + user.Name + "\n"
